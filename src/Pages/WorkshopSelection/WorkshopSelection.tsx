...
const WorkshopSelection = () => {
    ...
    return (
        <div
            className={"select-none flex flex-col justify-center gap-4 bg-black bg-opacity-65 backdrop-blur-lg w-full md:w-5/6 h-svh md:h-5/6 text-white md:rounded-2xl py-6 px-8"}>
            ...
            <span className={"flex justify-between items-center"}>
                ...
                <h2 className={"text-xl font-bold text-red-500 border border-red-500 p-4 rounded"}>You can only register your workshops once</h2>
            </span>
            {isMobile &&
            ...
            <button disabled={selectedWorkshopIDs.length === 0} type={"button"} onClick={openConfirmation}
                    className={"disabled:bg-gray-400 self-center bg-blue-600 shadow-xl rounded-2xl py-3 w-1/3 h-[5rem] lg:h-[4rem] text-xl hover:bg-blue-700 hover:text-white duration-300"}>
